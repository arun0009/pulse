...
- **PII masking log converter** for the JSON layout (emails, credit-card-shaped numbers, JWT-shaped tokens).
...
- **Histograms + SLOs** — opinionated bucket defaults at the 100ms / 500ms / 1s / 2s boundaries.
