...
class PiiMaskingConverterTest {
    ...
    @Test
    void credit_card_numbers_are_masked() {
        // Visa
        assertThat(PiiMaskingConverter.mask("card=4111111111111111 tx ok"))
                .doesNotContain("4111111111111111")
                .contains("[CREDIT_CARD]");
    }

    @Test
    void credit_card_with_separators_is_masked() {
        // Visa with dashes
        assertThat(PiiMaskingConverter.mask("card: 4111-1111-1111-1111 done"))
